...
void man( char *name )
{
	...
	{
		printf( "Descriptiion: Used to create new regular file \n" );
		printf( "Useage: create File_Name Permission \n" );
	}
	else if ( strcmp ( name , "read" ) == 0 )
	{
		printf("Description: Used to read the data from regular file\n");
		printf( "Useage: read File_Name No_Of_Bytes_To_Read \n" );
	}
	else if ( strcmp ( name , "write" ) == 0 )
	{
		printf("Description: Use to write into regular file \n");
		printf( "Useage: write File)Name\nAfter this enter the data that we want to write\n" );

	}
	else if ( strcmp ( name , "ls" ) == 0 )
	{
		printf("Description: Used to list all the information of the files");
		printf( "Useage: Ls\n" );
	}
...
int CreateFile( char *name , int permission )
{
	...
	{
		/*-> 24 nov*/(SUPERBLOCKobj.FreeInode)++;
		return -3;
	}
...
int main()
{
	...
	while ( 1 )
	{
		...
		count = sscanf( str , "%s %s %s %s" , command[0] , command[1] , command[2] , command[0] );
		...
		else if ( count == 4 )
		{
			if( strcmp( command[0] , "lseek" ) == 0 )
			{
				...
				if( ret == -1 )
				{
					printf( "ERROR: unable to performlseek\n" );
				}
			}
			else
			{
				printf( "\nERROR: unable to perfor, lseek\n" );	
			}
		}
